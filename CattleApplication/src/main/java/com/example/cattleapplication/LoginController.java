...
public class LoginController {
    ...
    @FXML
    private Label hashedPasswordLabel; // Label to display the hashed password
    ...
    @FXML
    private void handleConvertPassword() {
        String password = passwordField.getText(); // Get the entered password
        String hashedPassword = ChecksumGenerator.generateChecksum(password); // Generate MD5 hash
        hashedPasswordLabel.setText(hashedPassword); // Display the hashed password
    }
